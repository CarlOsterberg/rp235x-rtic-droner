...
pub type InterruptPinIMU =
    gpio::Pin<gpio::bank0::Gpio13, gpio::FunctionSio<gpio::SioInput>, gpio::PullUp>;
...
pub type InterruptPinNRF =
    gpio::Pin<gpio::bank0::Gpio6, gpio::FunctionSio<gpio::SioInput>, gpio::PullDown>;
